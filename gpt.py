...
class GptTextAnalyzer:
    ...
    def get_info(self, text: str) -> TextInfo:
        response = self._client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "Дан текст, определи заголовок, 3 главных тега и summary, которые могли бы описать этот текст. Теги должны быть короткими и понятными ключевыми словами или фразами. Результат должен быть в формате json. Summary на русском языке"},
